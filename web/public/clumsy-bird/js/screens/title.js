game.TitleScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        this.handler = me.event.subscribe(me.event.KEYDOWN, function (action, keyCode, edge) {
            if (action === "enter" || action === "fly") {
                me.state.change(me.state.PLAY);
            }
        });

        // Parent Space iletimi (queueFlap) title'da poll edilir
        this.flapPoll = me.timer.setInterval(function () {
            if (game.data.flapQueued) {
                game.data.flapQueued = false;
                me.state.change(me.state.PLAY);
            }
        }, 50);
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init: function() {
                ...
                this.text = me.device.touch ? 'Tap to start' : 'SPACE VEYA TIKLA';
    ...
    onDestroyEvent: function() {
        ...
        if (this.flapPoll) {
            me.timer.clearInterval(this.flapPoll);
            this.flapPoll = null;
        }
